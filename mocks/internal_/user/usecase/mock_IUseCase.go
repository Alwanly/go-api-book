...
func (_m *MockIUseCase) Auth(ctx context.Context, req *schema.AuthLoginRequest) utils.JSONResult {
	...
	var r0 utils.JSONResult
	if rf, ok := ret.Get(0).(func(context.Context, *schema.AuthLoginRequest) utils.JSONResult); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Get(0).(utils.JSONResult)
	}
...
func (_c *MockIUseCase_Auth_Call) Return(_a0 utils.JSONResult) *MockIUseCase_Auth_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIUseCase_Auth_Call) RunAndReturn(run func(context.Context, *schema.AuthLoginRequest) utils.JSONResult) *MockIUseCase_Auth_Call {
	_c.Call.Return(run)
	return _c
}

// Profile provides a mock function with given fields: _a0, _a1
func (_m *MockIUseCase) Profile(_a0 context.Context, _a1 *schema.ProfileRequest) utils.JSONResult {
	...
	var r0 utils.JSONResult
	if rf, ok := ret.Get(0).(func(context.Context, *schema.ProfileRequest) utils.JSONResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(utils.JSONResult)
	}
...
func (_c *MockIUseCase_Profile_Call) Return(_a0 utils.JSONResult) *MockIUseCase_Profile_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIUseCase_Profile_Call) RunAndReturn(run func(context.Context, *schema.ProfileRequest) utils.JSONResult) *MockIUseCase_Profile_Call {
	_c.Call.Return(run)
	return _c
}

// Register provides a mock function with given fields: ctx, req
func (_m *MockIUseCase) Register(ctx context.Context, req *schema.AuthRegisterRequest) utils.JSONResult {
	ret := _m.Called(ctx, req)
	...
	var r0 utils.JSONResult
	if rf, ok := ret.Get(0).(func(context.Context, *schema.AuthRegisterRequest) utils.JSONResult); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Get(0).(utils.JSONResult)
	}
...
func (_c *MockIUseCase_Register_Call) Return(_a0 utils.JSONResult) *MockIUseCase_Register_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIUseCase_Register_Call) RunAndReturn(run func(context.Context, *schema.AuthRegisterRequest) utils.JSONResult) *MockIUseCase_Register_Call {
	_c.Call.Return(run)
	return _c
}
